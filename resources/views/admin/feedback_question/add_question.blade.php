   ...
   <div class="col-md-10 offset-md-1 grid-margin stretch-card">
              <div class="card">
               ...
               @if (session('er_status'))
                ...
                @endif
                  <h4 class="card-title">Add Training Questions</h4>
                  
                <form class="forms-sample" method="post" action="{{url('admin/store_question')}}" enctype="multipart/form-data" id="create_company">
                  @csrf
				  <!--<div class="form-group ">
                    ...
                    <div class="form-group ">
                      <button type="submit" id="mySubmit"  class="btn btn-primary mr-2" disabled>Submit</button>
                    </div>
                  </form>
                </div>
              </div>
